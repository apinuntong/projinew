...
void setup() 
{
  Serial.begin(9600);
  myservo.attach(3);
  myservoyaw.attach(A0);// เปลียนขาใช้งานด้วยนะ
  myservopitch.attach(A1);//
  myservoroll.attach(A2);//
  myservo.write(90);
  myservoyaw.write(90);
...
//      Serial.println(" ");
//        Serial.println(((int16_t)rx_buf[7])<<8 | (int16_t)rx_buf[8]);
//      Serial.println(" ");
//      Serial.print(((int16_t)rx_buf[9])<<8 | (int16_t)rx_buf[10]);
//      Serial.println(" ");
//      Serial.print(((int16_t)rx_buf[11])<<8 | (int16_t)rx_buf[12]);
//      Serial.println(" ");
//    Serial.println(((int16_t)rx_buf[13])<<8 | (int16_t)rx_buf[14]);
//     Serial.println(" ");
////////////////////////////////////////////////////////////////////////
...
//          Serial.println(" ");          
///////////////////////////////////////////////////
      int val=((int16_t)rx_buf[11])<<8 | (int16_t)rx_buf[12];
